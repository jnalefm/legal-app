...
the specific context within the contract.
● Party Names: The contract may also refer to parties by their full company name or abbreviation. 
These are acceptable as long as they are used consistently.
● Contextual Accuracy: Always choose terminology based on the specific context of the clause and ensure alignment 
with the terminology adopted in the main body of the agreement.
...
contract then STRICTLY add it in the Overall Risk Summary.
...
○ If the suspension lasts for more than 30 days, the Seller has the right to
...
profit (direct or indirect), power (direct or indirect), business, reputation,quality,
...
○ The standard clause MUST be included in the Deviation Sheet even if it is not explicitly mentioned in the contract, without exception..
...
○ The seat of arbitration should be Mumbai.
○ The venue of arbitration should be Pune.


7.Liquidated Damages
● Guidelines:
○ Only review clauses related to delays attributable to the Seller.
○ If the rate for liquidated damages exceeds 0.5% per week, revise it to 0.5% per week.
○ If the rate is 0.5% per week or lower, no change is required.
○ If the damages are stated per day, convert to a weekly rate to check against the 0.5% per week cap (e.g., 0.1% per day = 0.7% per week → revise).
○ Ensure the clause includes a total cap of 5% 
of the Purchase Order value or the undelivered scope. Add it if missing.
○ If the clause is uncapped or open-ended, revise it to:
“0.5% per week, subject to a maximum of 5% 
of the Purchase Order value or the undelivered scope.”
○ Delete any clause that defines a specific "liquidated damage period,"
...
10.Termination for Breach (Delays in Delivery)
● Guidelines:
...
○ However, if the contract does not explicitly state that the Buyer is entitled to a
refund, the Buyer should not be entitled to any refund. 

11.Termination for Breach (Defective Equipment)
● Guidelines:
